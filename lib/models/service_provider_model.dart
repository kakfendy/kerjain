...
List<ServiceProviderModel> getPlumbers() {
  ...
  list.add(ServiceProviderModel(0, "Dedi Suryadi", homeCleaner, "Home Clean",
      "3.5", "Hi", "120", "350", false, getProviderServices()));
  list.add(ServiceProviderModel(0, "Joko Suparjo", plumber, "Plumbers", "4.5",
      "Hi", "120", "250", false, getProviderServices()));
  list.add(ServiceProviderModel(0, "Suprapto Wijoyo", electrician,
      "Electrician", "4.0", "Hi", "120", "310", false, getProviderServices()));
  return list;
}

List<ServiceProviderModel> getElectricians() {
  List<ServiceProviderModel> list = List.empty(growable: true);
  list.add(ServiceProviderModel(1, "Wawan Budiman", electrician, "Electrician",
      "3.5", "Hi", "120", "250", false, getProviderServices()));
  list.add(ServiceProviderModel(1, "Wawan Budiman", painter1, "painter", "3.5",
      "Hi", "120", "150", false, getProviderServices()));
  list.add(ServiceProviderModel(1, "Joko Suparjo", homeCleaner, "Home Clean",
      "4.5", "Hi", "120", "220", false, getProviderServices()));
  list.add(ServiceProviderModel(1, "Candra Budimanto", plumber, "plumber",
...
List<ServiceProviderModel> getPainters() {
  List<ServiceProviderModel> list = List.empty(growable: true);
  list.add(ServiceProviderModel(2, "Wawan Budiman", painter, "Painters", "3.5",
      "Hi", "120", "450", false, getProviderServices()));
  list.add(ServiceProviderModel(2, "Wawan Budiman", painter1, "Painters", "3.5",
      "Hi", "120", "550", false, getProviderServices()));
  list.add(ServiceProviderModel(2, "Joko Suparjo", painter, "Painters", "4.5",
      "Hi", "120", "500", false, getProviderServices()));
  list.add(ServiceProviderModel(2, "Candra Budimanto", painter, "Electrician",
      "4.0", "Hi", "120", "550", false, getProviderServices()));
  return list;
}

List<ServiceProviderModel> getCarpenters() {
  List<ServiceProviderModel> list = List.empty(growable: true);
  list.add(ServiceProviderModel(3, "Wawan Budiman", carpenter, "Carpenters",
      "3.5", "Hi", "120", "150", false, getProviderServices()));
  list.add(ServiceProviderModel(3, "Wawan Budiman", carpenter, "Carpenters",
      "3.5", "Hi", "120", "100", false, getProviderServices()));
  list.add(ServiceProviderModel(3, "Joko Suparjo", carpenter, "Carpenters",
      "4.5", "Hi", "120", "250", false, getProviderServices()));
  list.add(ServiceProviderModel(3, "Candra Budimanto", carpenter, "Carpenters",
