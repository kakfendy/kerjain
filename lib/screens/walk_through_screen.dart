...
class _WalkThroughScreenState extends State<WalkThroughScreen> {
  ...
  void init() async {
    list.add(
      WalkThroughModel(
        "Beri Sentuhan Baru untuk Rumah mu",
        "Temukan layanan terbaik untuk rumah Anda, karena kami menyediakan semua yang Anda butuhkan",
        room,
      ),
    );
    list.add(
    ...
    list.add(
      WalkThroughModel(
        "Layanan Mudah & Cepat",
        "Pesan layanan sesuai waktu yang Anda inginkan dan nikmati proses yang bebas repot.",
        contractor,
      ),
    );
  }
